...
export const formSchema = z.object({
  ...
  adults: z
    .string()
    .min(1, {
      message: "Please select at least 1 adults",
    })
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel className="text-white flex">
                  Location
                  <LuBedDouble className="ml-2 h-4 w-4 text-white" />
                </FormLabel>
                <FormMessage />
                <FormControl>
                  <Input placeholder="Londan, Uk" {...field} />
                </FormControl>
              </FormItem>
            )}
          />
                ...
                <Popover>
                  <PopoverTrigger asChild>
                    <FormControl>
                      ...
                      >
                        <IoCalendarNumberOutline className="mr-3 h-4 w-4 opacity-50" />
                        {field.value?.from ? (
                          field.value?.to ? (
                            <>
